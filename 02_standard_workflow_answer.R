...
str(nsclc.seurat.obj)
# counts: raw sparse matrix; data: log normalized; scale.data: scaled
...
# colored based on principle component scores; genes that indicate heterogeneity among cells; 
# we can also inspect other PCs if they capture heterogeneity
