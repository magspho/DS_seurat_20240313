...
homotypic.prop <- modelHomotypic(annotations)           ## ex: annotations <- seurat.obj@meta.data$ClusteringResults
nExp_poi <- round(0.076*nrow(pbmc.seurat.filtered@meta.data))  ## Assuming 7.6% doublet formation rate - tailor for your dataset
